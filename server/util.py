...
__this_script = pathlib.Path(__file__)
...
def load_saved_artifacts():
    ...
    global __this_script
    
    json_path = __this_script.parent / "artifacts" / "class_dictionary.json"
    ...
    global __model
    if __model is None:
        model_path = __this_script.parent / "artifacts" / "saved_model.pkl"
...
def get_b64_test_image_for_virat():
    b64_path = __this_script.parent / "b64.txt"
